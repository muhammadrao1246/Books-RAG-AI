...
# expires in 6 months
oauth2_settings.DEFAULTS['ACCESS_TOKEN_EXPIRE_SECONDS'] = 3600 * 24 *30 # 1 month token expiry date
...
#     # Custom function to handle Facebook login
#     # 'api.auth_pipeline.custom_user_details',
...
SOCIAL_AUTH_USER_FIELDS=['username', 'email','fullname','password']
...
get_complete_url = lambda url: f"{MEDIA_ROOT}{url}" if USE_CLOUD_STORAGE == "local" else url
